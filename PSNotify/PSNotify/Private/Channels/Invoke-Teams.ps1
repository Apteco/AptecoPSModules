...
function Invoke-Teams {
    ...
    Begin {
        ...
        $channel = Get-TeamsChannel -Name $Name

        # Decrypt webhook url
        $webhook = Convert-SecureToPlaintext -String $channel.definition.webhook
    ...
    Process {
        ...
        $updatedParameters.Uri = $webhook #$uriRequest.Uri.OriginalString
