[PSCustomObject]@{
    ...
    "keyfile" = $null                                       # Define a path in here, if you use another keyfile for https://www.powershellgallery.com/packages/EncryptCredential/0.0.2
    ...
    "token" = [PSCustomObject]@{
        ...
        "tokenFilePath" = "xyz"                             # path for the file that should be consumed or generated
