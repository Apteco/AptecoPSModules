...
GUID = 'dbab428f-2d9c-4241-ba95-09462b7caade'
...
Description = 'Apteco PS Modules - Apteco Orbit API client
...
PrivateData = @{
    ...
    PSData = @{
        ...
        Tags = @('powershell', "PSEdition_Desktop", "PSEdition_Core", "Windows", "Apteco", "Orbit", "PeopleStage")

        # A URL to the license for this module.
        LicenseUri = 'https://gist.github.com/gitfvb/58930387ee8677b5ccef93ffc115d836'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/Apteco/AptecoPSModules/tree/main/InvokeAptecoOrbit'
